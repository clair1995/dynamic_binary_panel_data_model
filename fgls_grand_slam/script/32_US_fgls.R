...
dfA<-readRDS(file_id$file_temp_service$US_service_A) 
dfB<-readRDS(file_id$file_temp_service$US_service_B) 
...
saveRDS(conv$df_finale, file = file_id$output_df$out_df_US)
...
saveRDS(mod.rid, file = file_id$output_mod$out_mod_US)
